package pe.goblin.resourceservice.domain.support.mail.service;
...
import pe.goblin.resourceservice.domain.support.mail.MailTemplateResolver;
import pe.goblin.resourceservice.domain.support.mail.client.MailClient;
...
import pe.goblin.resourceservice.domain.support.mail.exception.MailException;
import pe.goblin.resourceservice.domain.support.mail.exception.MailTemplateException;
import pe.goblin.resourceservice.domain.support.mail.exception.MailTransportException;
import pe.goblin.resourceservice.domain.support.mail.repository.MailEventRepository;
